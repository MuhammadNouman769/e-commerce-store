    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('suspended', 'Suspended'), ('pending', 'Pending Verification')], default='pending', max_length=20, verbose_name='Account Status')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['role'], name='accounts_us_role_1fa9a5_idx'), models.Index(fields=['account_status'], name='accounts_us_account_8a6ddb_idx')],
            },
        ),
    ]
